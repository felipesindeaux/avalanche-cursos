...
MY_APPS = ["users", "categories", "courses", "students", "reviews", "lessons", "questions", "answers"]
...
SPECTACULAR_SETTINGS = {
    ...
    "Description": "Pessoas de todos os tipos poderão criar e oferecer cursos de todos os tipos, sejam eles mais avançados, específicos, rasos, abrangentes e também com taxas de valores e durações das mais variadas possível.",
    "VERSION": "1.0",
